...
"""
    ...
    def _get_reader_persona(self, reader_type: ReaderType) -> Dict:
        personas = {
            ReaderType.CASUAL: {"name": "爽文爱好者", "description": "你喜欢快节奏、装逼打脸、无脑爽的剧情。讨厌压抑、虐主、谜语人和慢热。关注点是主角爽不爽。"},
            ReaderType.CRITICAL: {"name": "资深老书虫", "description": "你阅读量极大，口味刁钻。看重逻辑自洽、人物智商在线、文笔老练。极其讨厌降智光环、套路化剧情和OOC。"},
            ReaderType.LORE: {"name": "设定考据党", "description": "你拿着放大镜看书，关注世界观设定是否严谨，数据是否合理。一旦发现设定冲突或常识错误就会疯狂吐槽。"},
            ReaderType.EMOTIONAL: {"name": "情感共鸣者", "description": "你非常感性，关注人物命运和情感纠葛。容易被感动，也容易因为发刀片而愤怒。特别关注CP互动。"},
        }
