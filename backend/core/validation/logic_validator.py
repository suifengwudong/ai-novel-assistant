...
class LogicValidator:
    ...
    async def check(self, content: str, core_knowledge: List[str], locked_settings: Dict[str, Any]) -> Dict[str, Any]:
        """
        校验内容逻辑
...
"""
        try:
            ...
            if isinstance(result, str):
                ...
                try:
                    ...
                    if "false" in cleaned.lower() or "冲突" in cleaned or "问题" in cleaned:
                        return {"passed": False, "issues": ["内容存在逻辑问题"], "suggestions": ["请检查内容逻辑一致性"]}
                    else:
            ...
            return {"passed": True, "issues": [f"校验服务异常: {str(e)}"], "suggestions": []}
